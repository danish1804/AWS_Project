...
FUNCTION_NAME=subscribeSong
HANDLER=com.amazonaws.project.SubscribeSongLambda::handleRequest
RUNTIME=java17
...
# Create /subscribe resource if needed
...
# -------------------- Final Output --------------------
echo ""
echo "✅ Subscribe endpoint ready at:"
